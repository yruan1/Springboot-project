...
public class StudentServicelmpl implements StudentService{
    ...
    public void deleteStudentById(long id) {
        studentRepository.findById(id).orElseThrow(()->new IllegalStateException("id:"+id+"has been taken"));
    ...
    public  StudentDTO updateStudentById(long id, String name, String email) {
        Student studentInDB = studentRepository.findById(id).orElseThrow(()->new IllegalStateException("id:"+id+"has been taken"));
